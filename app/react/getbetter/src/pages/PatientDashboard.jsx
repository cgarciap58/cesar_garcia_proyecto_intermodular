...
const PATIENT_ACTIONS = [
  ...
  { label: 'Add credits', variant: 'secondary' },
]
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {selectedAppointment && (
          <AppointmentDetail
            ...
            meetLinkLabel="Join session"
            previousLabel={`Previous sessions with Dr. ${selectedAppointment.psychologist.last_name}`}
