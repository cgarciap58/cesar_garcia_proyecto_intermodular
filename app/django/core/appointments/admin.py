...
class AvailableSlotAdmin(admin.ModelAdmin):
    list_display  = ('psychologist', 'start_time', 'duration_minutes', 'status', 'created_at')
    list_filter   = ('status', 'psychologist')
    search_fields = ('psychologist__user__username', 'psychologist__user__email')
    ordering      = ('start_time',)


@admin.register(Appointment)
class AppointmentAdmin(admin.ModelAdmin):
    list_display  = ('patient', 'get_psychologist', 'get_start_time', 'status', 'created_at', 'updated_at')
    list_filter   = ('status',)
    search_fields = ('patient__user__username', 'patient__user__email', 'slot__psychologist__user__username')
