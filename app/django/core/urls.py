...
from .bugs.views import submit_bug, list_bugs, assign_bug
...
urlpatterns = [
    ...
    # ── Bug reports ───────────────────────────────────────────────────────────
    # assign/ must be registered BEFORE the generic <id>/ path (none here, but good habit)
    path('api/bugs/<int:bug_id>/assign/', assign_bug),
    path('api/bugs/',                     submit_bug),   # POST — anyone
    path('api/bugs/list/',                list_bugs),    # GET  — admin / developer
]
