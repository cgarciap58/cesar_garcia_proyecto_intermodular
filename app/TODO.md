...
- [ ] Frontend & backend data structure bugs:
    ...
    - [ ] Age:
        ...
        - [ ] Localize country selection names in dropdown in /signup and /profile.

    - [ ] Navbar before logging
        - Navbar before logging should show:
            - [X] Logo on left (goes to "/")
            - On the right:
                - [ ] Home (goes to "/")
                - [ ] Testimonials (href when in "/", but navigate to "/#testimonials" if not the case)
                - [X] Log in
                - [X] Language switcher
